...
def parse_args():
    ...
    # basic parameters
    parser.add_argument('--model_name', type=str, default='QSMCEFN', help='the name of the model', choices=[
        'QSMCEFN', 'CLFormer', 'convoformer_v1_small', 'MobileNet', 'MobileNetV2', 'ResNet18', 'MSResNet','mcswint'])
    ...
    # dataset parameters
    parser.add_argument('--dataset_name', type=str, default='OU_bearing', help='the name of the dataset',
                        choices=['XJTU_gearbox', 'XJTU_spurgear', 'OU_bearing'])
    parser.add_argument('--sigma', type=int, default=0.2, help='the level of noise under noise task')
    ...
    # saving results
    parser.add_argument('--operation_num', type=int, default=1,
                        help='the repeat operation of model. If XJTU_spurgear, set 10; otherwise, set 5')
    parser.add_argument('--only_test', type=bool, default=True, help='loading the trained model if only test')
